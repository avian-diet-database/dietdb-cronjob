...
if not r.ok:
    printError("Source data url returned error: " + 'https://raw.githubusercontent.com/hurlbertlab/dietdatabase/master/AvianDietDatabase.txt')
    printElapsedTime()
    exit(1)
...
try:
    conn = mysql.connector.connect(port=9000,
                                   user='userFVC',
...
with open(approvedTableFile,'w',newline='\r\n',encoding='cp1252') as f:
